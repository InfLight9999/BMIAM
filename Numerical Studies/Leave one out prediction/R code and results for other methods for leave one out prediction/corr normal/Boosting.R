...
design1B<-read_csv("data/data_setting1_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design1B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
...
design2B<-read_csv("data/data_setting2_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design2B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
...
design3B<-read_csv("data/data_setting3_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design3B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
...
design4B<-read_csv("data/data_setting4_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design4B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
...
design5B<-read_csv("data/data_setting5_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design5B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
...
design6B<-read_csv("data/data_setting6_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design6B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
...
design7B<-read_csv("data/data_setting7_p6_DesignCorrNorm.csv",col_names = FALSE)
...
for (i in 1:100)
{
  boosting<-gbm(formula=X7~.,data = design7B[((i-1)*sample.size+1):(sample.size*i-1),], n.trees = 180)
