...
design1<-as.matrix(read_csv("data/data_setting1_p6_DesignIndNorm.csv",col_names = FALSE))
design1B<-read_csv("data/data_setting1_p6_DesignIndNorm.csv",col_names = FALSE)
...
design2<-as.matrix(read_csv("data/data_setting2_p6_DesignIndNorm.csv",col_names = FALSE))
design2B<-read_csv("data/data_setting2_p6_DesignIndNorm.csv",col_names = FALSE)
...
design3<-as.matrix(read_csv("data/data_setting3_p6_DesignIndNorm.csv",col_names = FALSE))
design3B<-read_csv("data/data_setting3_p6_DesignIndNorm.csv",col_names = FALSE)
...
design4<-as.matrix(read_csv("data/data_setting4_p6_DesignIndNorm.csv",col_names = FALSE))
design4B<-read_csv("data/data_setting4_p6_DesignIndNorm.csv",col_names = FALSE)
...
design5<-as.matrix(read_csv("data/data_setting5_p6_DesignIndNorm.csv",col_names = FALSE))
design5B<-read_csv("data/data_setting5_p6_DesignIndNorm.csv",col_names = FALSE)
...
design6<-as.matrix(read_csv("data/data_setting6_p6_DesignIndNorm.csv",col_names = FALSE))
design6B<-read_csv("data/data_setting6_p6_DesignIndNorm.csv",col_names = FALSE)
...
design7<-as.matrix(read_csv("data/data_setting7_p6_DesignIndNorm.csv",col_names = FALSE))
design7B<-read_csv("data/data_setting7_p6_DesignIndNorm.csv",col_names = FALSE)
