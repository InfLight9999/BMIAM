...
X1=X000[((datanum-1)*full_samplesize+1):(full_samplesize*datanum),:]
...
outfile2 = "../result/MSE_$(SETTING)_p$(DIM)_design$(DESIGN)_rep$(datanum).csv"
f2 = open(outfile2, "a")
println(f2, [datanum,mse_out,datanum])
close(f2)
